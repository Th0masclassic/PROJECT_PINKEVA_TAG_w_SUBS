...
const copies: Record<Language, CloudPlusCopy> = {
  en: {
    ...
    accountBody: 'Phone-aware protection and premium tools across your Pinkeva account.',
  ...
  pt: {
    ...
    accountBody: 'Proteção ligada ao telemóvel e ferramentas premium em toda a sua conta Pinkeva.',
  ...
  fr: {
    ...
    accountBody: 'Protection liée au téléphone et outils premium pour votre compte Pinkeva.',
  ...
  de: {
    ...
    accountBody: 'Telefonbasierter Schutz und Premium-Werkzeuge für dein Pinkeva-Konto.',
  ...
  zh: {
    ...
    accountBody: '为你的 Pinkeva 账户提供手机感知保护和高级工具。',
  ...
  it: {
    ...
    accountBody: 'Protezione collegata al telefono e strumenti premium per il tuo account Pinkeva.',
  ...
  es: {
    ...
    accountBody: 'Protección vinculada al teléfono y herramientas premium para tu cuenta Pinkeva.',
