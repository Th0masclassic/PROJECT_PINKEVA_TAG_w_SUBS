...
const copies: Record<Language, CloudPlusCopy> = {
  en: {
    ...
    accountBody: 'Phone-aware protection and premium tools for each subscribed Pinkeva tracker.',
    includedTitle: 'Included with Cloud +',
    recoveryTitle: 'Recovery protection',
    recoveryBody: 'Combine safe zones, phone proximity, and tracker reports when an item goes missing.',
    ...
    protectionLocked: 'Recovery protection is included with Pinkeva Cloud +.',
  ...
  pt: {
    ...
    accountBody: 'Proteção ligada ao telemóvel e ferramentas premium para cada localizador Pinkeva com subscrição.',
    includedTitle: 'Incluído no Cloud +',
    recoveryTitle: 'Proteção de recuperação',
    recoveryBody: 'Combine zonas seguras, proximidade do telemóvel e relatórios do localizador quando perder um objeto.',
    ...
    protectionLocked: 'A proteção de recuperação está incluída no Pinkeva Cloud +.',
  ...
  fr: {
    ...
    accountBody: 'Protection liée au téléphone et outils premium pour chaque traceur Pinkeva abonné.',
    includedTitle: 'Inclus avec Cloud +',
    recoveryTitle: 'Protection de récupération',
    recoveryBody: 'Combinez zones sûres, proximité du téléphone et signalements du traceur lorsqu’un objet disparaît.',
    ...
    protectionLocked: 'La protection de récupération est incluse avec Pinkeva Cloud +.',
  ...
  de: {
    ...
    accountBody: 'Telefonbasierter Schutz und Premium-Werkzeuge für jeden abonnierten Pinkeva-Tracker.',
    includedTitle: 'In Cloud + enthalten',
    recoveryTitle: 'Wiederfinde-Schutz',
    recoveryBody: 'Kombiniert sichere Zonen, Telefonnähe und Tracker-Berichte, wenn ein Gegenstand fehlt.',
    ...
    protectionLocked: 'Der Wiederfinde-Schutz ist in Pinkeva Cloud + enthalten.',
  ...
  zh: {
    ...
    accountBody: '为每个已订阅的 Pinkeva 追踪器提供手机感知保护和高级工具。',
    includedTitle: 'Cloud + 包含功能',
    recoveryTitle: '找回保护',
    recoveryBody: '物品丢失时，结合安全区域、手机距离和追踪器报告协助找回。',
    ...
    protectionLocked: 'Pinkeva Cloud + 包含找回保护。',
  ...
  it: {
    ...
    accountBody: 'Protezione collegata al telefono e strumenti premium per ogni tracker Pinkeva abbonato.',
    includedTitle: 'Incluso con Cloud +',
    recoveryTitle: 'Protezione di recupero',
    recoveryBody: 'Combina zone sicure, vicinanza del telefono e segnalazioni del tracker quando un oggetto scompare.',
    ...
    protectionLocked: 'La protezione di recupero è inclusa in Pinkeva Cloud +.',
  ...
  es: {
    ...
    accountBody: 'Protección vinculada al teléfono y herramientas premium para cada localizador Pinkeva suscrito.',
    includedTitle: 'Incluido con Cloud +',
    recoveryTitle: 'Protección de recuperación',
    recoveryBody: 'Combina zonas seguras, proximidad del teléfono e informes del localizador cuando se pierde un objeto.',
    ...
    protectionLocked: 'La protección de recuperación está incluida con Pinkeva Cloud +.',
