...
const copies: Record<Language, RenewalCopy> = {
  en: {
    ...
    updatesTitle: 'No tag update required',
    updatesPendingOne: '{{count}} tag needs a subscription update.',
    updatesPendingMany: '{{count}} tags need subscription updates.',
    updatesComplete: 'Renewals unlock cloud features automatically; your tags keep broadcasting.',
  ...
  pt: {
    ...
    updatesTitle: 'Não é necessário atualizar a tag',
    ...
    updatesComplete: 'As renovações ativam automaticamente as funcionalidades cloud; as tags continuam a transmitir.',
  ...
  fr: {
    ...
    updatesTitle: 'Aucune mise à jour du tag requise',
    ...
    updatesComplete: 'Les renouvellements activent automatiquement les services cloud ; vos tags continuent à émettre.',
  ...
  de: {
    ...
    updatesTitle: 'Kein Tag-Update erforderlich',
    ...
    updatesComplete: 'Verlängerungen schalten Cloud-Funktionen automatisch frei; deine Tags senden weiter.',
  ...
  zh: {
    ...
    updatesComplete: '续订会自动解锁云端功能；标签会继续广播。',
  ...
  it: {
    ...
    updatesTitle: 'Nessun aggiornamento del tag richiesto',
    ...
    updatesComplete: 'I rinnovi attivano automaticamente le funzioni cloud; i tag continuano a trasmettere.',
  ...
  es: {
    ...
    updatesTitle: 'No hace falta actualizar el tag',
    ...
    updatesComplete: 'Las renovaciones activan automáticamente las funciones en la nube; tus tags siguen emitiendo.',
